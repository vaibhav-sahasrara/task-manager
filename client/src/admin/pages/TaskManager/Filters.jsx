    ...
    <div className="flex flex-col lg:flex-row justify-between items-center gap-4 mb-6 px-2">
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <select
          ...
          className="px-4 py-2 rounded-full border border-gray-300 dark:border-gray-600 shadow-sm bg-white dark:bg-gray-800 text-sm text-gray-700 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-400"
        >
          <option value="">All Priorities</option>
          {priorities.map((p) => (
            <option key={p}>{p}</option>
