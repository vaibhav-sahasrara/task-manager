  ...
  return (
    <div className="space-y-4">
      {dummyNotifications.map((note) => (
        <div
          key={note.id}
          className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 p-4 rounded-lg shadow hover:shadow-md transition"
        >
          <p className="text-sm text-gray-800 dark:text-gray-100">{note.message}</p>
