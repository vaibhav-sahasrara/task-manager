...
const ClientReports = () => {
  return (
    <div>
      <h2 className="text-xl font-semibold mb-4 text-indigo-700 dark:text-yellow-300">
        Project Reports
      </h2>
      <div className="space-y-4">
        {dummyReports.map((report) => (
          <div
            key={report.id}
            className="p-4 bg-white dark:bg-gray-800 shadow-md rounded-lg border border-gray-100 dark:border-gray-700"
          >
